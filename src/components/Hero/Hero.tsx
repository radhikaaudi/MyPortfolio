...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black  py-18 px-6 md:px-12">
      {/* Grid background */}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full sm:w-11/12 md:w-10/12 lg:w-7/12">
            <div>
              <h2 
                ref={nameRef}
                className="font-mono opacity-0 transform translate-y-8 transition-all duration-700 text-xl md:text-2xl text-white mb-7 pt-20"
              >
                Hey, I'm
              </h2>
              <h1 
 ...
 text-[#ff44cc] mb-8">
              ...
              <p 
                ref={descriptionRef}
                className="opacity-0 transform translate-y-8 transition-all duration-700 delay-600 text-[#8dc6ff] text-base sm:text-lg md:text-xl max-w-2xl mb-12"
              >
              I’m currently pursuing B.Tech in CCE at LNMIIT. I love crafting dynamic web and mobile apps using Frontend and Backend and exploring GenAI tools like Cursor and Bolt to build smarter experiences with LLM integrations.
...
I’m driven by the blend of tech and creativity to solve real-world problems and build communities that grow together.
          ...
          <div 
            ref={imageRef}
            className="w-full sm:w-8/12 md:w-7/12 lg:w-3/12 mt-10 lg:mt-0 opacity-0 translate-y-8 transition-all duration-1000"
          >
           {/* TV Frame Effect */}
<div className="relative">
  ...
  <div className="relative bg-black rounded-xl p-2">
    ...
    <div className="relative rounded-lg overflow-hidden bg-[#4d4dff]/10 backdrop-blur-sm">
      {/* Image Container */}
      <div className="aspect-[4/4.5] relative overflow-hidden rounded-lg">
        {/* Your content here */}
